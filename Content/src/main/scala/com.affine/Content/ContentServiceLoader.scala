...
import com.affine.Content.entity.ContentEntityDatabase
...
object ContentServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new ContentService(serviceIdentity, producer, untypedSystem, new ContentEntityDatabase(context.system, producer))
  ...
  val system = akka.actor.ActorSystem("content")
