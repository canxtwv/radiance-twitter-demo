...
import com.affine.Twitter.entity.TwitteruserEntityDatabase
...
object TwitterServiceLoader extends App{
  ...
  val k8sBehavior : Behavior[NotUsed] =
    Behaviors.setup { context =>
      ...
      lazy val service = new TwitterService(serviceIdentity, producer, untypedSystem, new TwitteruserEntityDatabase(context.system, producer))
  ...
  val system = akka.actor.ActorSystem("twitter")
